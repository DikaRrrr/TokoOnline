            ...
            <tbody> 
                ...
                <tr> 
                    ...
                    <td> 
                        ...
                        <!-- Modal --> 
                        <div class="modal fade" id="orderDetailModal{{ $order->noresi }}" tabindex="-1" role="dialog" aria-labelledby="orderDetailModalLabel{{ $order->noresi }}" aria-hidden="true"> 
                            <div class="modal-dialog" role="document"> 
                                <div class="modal-content"> 
                                    <div class="modal-header"> 
                                        <h5 class="modal-title" id="orderDetailModalLabel{{ $order->id }}">Detail Pesanan #{{ $order->noresi }}</h5> 
