...
<head>
    ...
    <!-- Bootstrap -->
    <link type="text/css" rel="stylesheet" href="{{ asset('frontend/eshop/css/bootstrap.min.css') }}">

    <!-- Slick -->
    <link type="text/css" rel="stylesheet" href="{{ asset('frontend/eshop/css/slick.css') }}">
    <link type="text/css" rel="stylesheet" href="{{ asset('frontend/eshop/css/slick-theme.css') }}">

    <!-- nouislider -->
    <link type="text/css" rel="stylesheet" href="{{ asset('frontend/eshop/css/nouislider.min.css') }}">

    <!-- Font Awesome Icon -->
    <link rel="stylesheet" href="{{ asset('frontend/eshop/css/font-awesome.min.css') }}">
...
<body>
                    ...
                    <div class="aside">
                        ...
                        <div class="product product-widget">
                            <div class="product-thumb">
                                <img src="{{ asset('frontend/eshop/img/thumb-product01.jpg') }}" alt="">
                            </div>
    ...
    <!-- jQuery Plugins -->
    <script src="{{ asset('frontend/eshop/js/jquery.min.js') }}"></script>
    <script src="{{ asset('frontend/eshop/js/bootstrap.min.js') }}"></script>
    <script src="{{ asset('frontend/eshop/js/slick.min.js') }}"></script>
    <script src="{{ asset('frontend/eshop/js/nouislider.min.js') }}"></script>
